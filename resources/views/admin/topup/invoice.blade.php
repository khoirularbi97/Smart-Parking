...
/>
<div class="bg-white border-4 border-indigo-200 border-t-purple-500 shadow rounded flex items-center justify-center py-10">
    <div class="bg-white w-[360px] rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-white rounded-t-xl -mt-5 px-6 pt-6 pb-8 text-gray-700 text-sm">
            ...
            <div class="mt-6">
                ...
                <button onclick="window.print()" class="btn wide-full block bg-green-500 hover:bg-green-600 text-white text-center py-3 rounded-lg text-sm font-semibold shadow-md">
                🖨️ Cetak Invoice
                </button>
