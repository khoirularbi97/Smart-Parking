  ...
  <aside class="w-85 min-h-screen border-white border-b border-t bg-sky-600 text-white p-5 shadow-lg hidden md:block z-40">
    ...
    <nav  class="space-y-3">
        <ul>
            <li class="mb-3">
                <a href="{{ route('dashboard') }}"  class="flex items-center border-white border-b border-t p-3 rounded-lg hover:bg-sky-500 transition{{ request()->is('dashboard') ? 'bg-sky-500' : 'bg-transparent'}}">
            ...
            <li class="mb-3 border-white border-b border-t rounded-lg transition">
                    <button type="button"
                        ...
                        <svg class="w-4 h-4 ml-auto transition-transform" id="icon-parkirDropdown" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <ul id="parkirDropdown" class="mt-2 ml-8 space-y-2 hidden mb-2">
                        <li>
                            <a href="{{ route('parkir.masuk') }}"
                            class="flex items-center border-white border-b border-t ml-8 p-2 rounded-md hover:bg-sky-700 {{ request()->is('parkir_masuk') ? 'bg-sky-500' : '' }}"><i data-lucide="arrow-right-to-line"></i>
                        ...
                        <li>
                            ...
                            <a href="{{ route('parkir.keluar') }}"
                                class="flex items-center border-white border-b border-t ml-8 p-2 rounded-md hover:bg-sky-700 {{ request()->is('parkir_keluar') ? 'bg-sky-500' : '' }}"><i data-lucide="arrow-left-from-line"></i>
