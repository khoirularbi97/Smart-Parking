        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center p-4">
            ...
            <nav class="flex items-center justify-end gap-4">
                @auth
                    <a
                        href="{{ url('/dashboard') }}"
                        class="bg-gray-100 text-white-800 px-6 py-3 rounded-lg hover:bg-cyan-400 transition"
                    >
                        Dashboard
                    </a>
                    {{-- inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#1915014a] hover:bg-gray-300 border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-sm leading-normal --}}
                @else
                    <a
                        href="{{ route('login') }}"
                        class="bg-gray-100 text-white-800 px-6 py-3 rounded-lg hover:bg-cyan-400 transition">
